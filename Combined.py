...
class ObservationExtractor:
    ...
    def process_with_groq(self, extracted_text):
        try:
            system_prompt = """You are an AI assistant for a learning observation system..."""  # Keep your original prompt
...
def admin_dashboard():
    ...
    tab1, tab2 = st.tabs(["Mappings", "Activity Logs"])
            ...
            with st.spinner("Processing..."):
                try:
                    ...
                    supabase.table('observations').insert({
                        ...
                        "child_id": data['studentId'],  # Assuming studentId is child_id
        ...
        if uploaded_file and st.button("Process"):
            with st.spinner("Transcribing..."):
                ...
                supabase.table('observations').insert({
                    ...
                    "child_id": "AUDIO_SESSION",  # Replace with actual child ID mapping
                    "observer_id": username,
